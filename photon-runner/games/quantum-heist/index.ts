...
import { createHumanoid, Humanoid } from '../lab/character';
...
import { INTERACT_RADIUS, REPEATABLE, StationDef, TerminalKind, scoredStations, stationsFor } from './stations';
import {
  CRISIS_INFO,
  CrisisKind,
  GameState,
...
export type { Outcome } from './logic';
